...
<style>
#header {
  background: black url('diverge_and_me.JPG') center no-repeat;
...
First, I include some of my experiences in a dataframe. It would be more fun (and perhaps more efficient when it comes to updating) to scrape my actual CV, maybe I'll write about it as a blog post.
