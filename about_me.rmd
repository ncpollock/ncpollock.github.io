...
![Trying to get images to work!](diverge_and_me.JPG)
...
# this worked, it rendered two images
# `r knitr::include_graphics('diverge_and_me.JPG')`
```
...
#could have built it in R instead ###########
...
```{r cv_plot, echo=FALSE, warning=FALSE, fig.width=8.5, fig.height=25,fig.align='center'}
