...
# #header {
#   background: url('images/diverge_and_me.JPG') center no-repeat;
...
Just for fun, I also recreated some of my CV using ggplot2. Obviously, it needs some work (e.g., vertical spacing adjustments), but I hope it conveys my passion (obsession?) for coding in R.
...
```{r cv_df_plot, echo=TRUE, warning=FALSE, fig.width=8.5, fig.height=25,fig.align='center'}
...
```{r sandbox, echo=FALSE, warning=FALSE, include=FALSE}
