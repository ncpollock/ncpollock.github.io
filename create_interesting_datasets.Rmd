...
# lapply(1:3,function(x) sample(x,size=x))
...
# lapply(1:3,function(x) sample(x,size=x,replace=TRUE))
...
Here's a basic plot showing the number of graduates with each post-graduation outcome.
