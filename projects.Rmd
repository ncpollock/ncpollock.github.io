...
div(class="panel-body"
, fluidRow(
tile(s = "images/flow_handshake.JPG", t="Data Pipeline to Handshake",h="https://joinhandshake.com/"
       , d = "Oakland University Career Services needed to move fresh data daily over from their ERP to a SaaS product powering on-campus jobs, community internships, and post-graduation employment for the entire campus community.")
)
)
```
